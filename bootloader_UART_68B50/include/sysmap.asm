...
;	(en este caso el Z80) para dar soporte a ćódigo en C.
;
...
;--------------------------------------------------------------------------------------
	...
	;; Inicio de la inicialización del bootloader.
	;; El programa comienza en la dirección 6800H, los últimos 6k de
	;; la memoria EEPROM. Si el bootloader ocupa mas de 6k, cambiar este valor.
	.org	0x6800
init_bootloader:
